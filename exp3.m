...
for iDMUo=1:J
    ...
    [BestBuffRank,RunTime,UpperRankOfBuffRank]=BestEcoBuffRankOpt(mInput,mOutput,iDMUo,params);
    ...
    [WorstBuffRank,RunTime,LowerRankOfBuffRank]=WorstEcoBuffRankOpt(mInput,mOutput,iDMUo,params);
